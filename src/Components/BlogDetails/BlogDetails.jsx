    ...
    <div className="BlogDetails">
      ...
      <Row className="align-items-center mt-5 gap-5 mb-5">
        ...
        <Col md={5} className="text-md-end text-center mb-3 mb-md-0">
          ...
          <a href="#" className="text-white border rounded p-2"><FaXTwitter size={30} /></a>
            <a href="#"  className="text-white border rounded p-2"><FaInstagram size={30} /></a>
            <a href="#"  className="text-white border rounded p-2"><FaFacebook size={30} /></a>
            <a href="#"  className="text-white border rounded p-2"><FaWhatsapp  size={30} /></a>
           
          </div>
          <span className="fw-bold px-3 fs-5">:
            مشاركة المقال عبر </span>
        </Col>

        {/* القسم الأيمن - النص */}
        <Col md={6} className="text-md-end text-center">
          <h1 className="fw-bold text-white mb-5 fs-1">تشتغل بالعمل الحر؟ اضمن <br/>عرونك وكل مستحقاتك مع وفّي</h1>
...
<Container fluid className="my-5 text-center px-5 " style={{backgroundColor: "#f8fafb"}}>
      {/* العنوان الرئيسي */}
      <h2 className="fw-bold text-dark fs-2">
        هل أنت تعمل بالعمل الحر؟ تبي تضمن عرڤونك وتحمي كل مستحقاتك بطريقة موثوقة ومضمونة؟
        مع خدمة وفّي ,تقدر تطمئن وتشتغل براحة بال وبثقة
      </h2>

      {/* زر التحميل */}
      <button  className=" mt-3 px-4 py-3 fs-5 border-0 rounded-pill text-white" style={{backgroundColor:"#0693e3"}}>
  ...
  <h1 className="fw-bold  text-muted"> ليش تختار خدمة ضمان وفّي؟</h1>
          <p className="mb-4">
            ...
            <strong>ضمان العملاء:</strong> مع وفّي، يمكنك كفريلانسر ضمان استلام عربونك بأمان
          </p>
          <p className="mb-4">
            <FaMoneyBillWave className="text-warning me-2" />
            <strong>حماية المدفوعات:</strong> نحن هنا لضمان استلامك لكل مستحقاتك، حيث يتم حفظ العربون بشكل آمن حتى تكتمل الخدمة بالكامل
          </p>
          <p className="mb-4">
            <FaLock className="text-warning me-2" />
            <strong>سلامة المعاملات: </strong>  توفر خدمة وفّي بيئة آمنة وموثوقة لإجراء المعاملات، مما يضمن سلامة عربونك  ومستحقاتك  
          </p>
          ...
          <p className="mb-4">
            <strong>تحديد الشروط:</strong> قم بتحديد شروط العمل والمبلغ المطلوب كعرڤون.
          </p>
          <p className="mb-4">
            <strong>دفع العرڤون:</strong> نحن نقوم بحجز المبلغ بشكل آمن حتى اكتمال الخدمة.
          </p>
    
          <p className="mb-4">
            <strong> إتمام الخدمة:</strong> بمجرد إتمام الخدمة بالكامل ورضا العميل، يتم تحويل العربون ومستحقاتك بالكامل إليك
          </p>
      ...
      <h1 className="fw-bold text-dark  mt-5 pt-5">
          انضم إلينا اليوم واستمتع بحماية عربونك ومستحقاتك كفريلانسر بثقة وأمان مع وفّي
      </h1>

      {/* زر التحميل */}
      <button  className=" mt-3 px-4 py-3 mb-5 fs-5 border-0 rounded-pill text-white" style={{backgroundColor:"#0693e3"}}>
       ابدأ معاملتك الآن
      </button>
